            ...
            <form onSubmit={handleUpdateProfile} className="space-y-6 md:space-y-8">
                ...
                <div className="bg-gray-50/50 dark:bg-slate-900/50 p-5 md:p-8 rounded-[1.5rem] border border-gray-100 dark:border-slate-800 space-y-5">
                    ...
                    <div>
                        ...
                        <Input type="tel" value={whatsappNumber} onChange={(e) => setWhatsappNumber(e.target.value)} placeholder="e.g. 918158926581" className="mt-1 h-12 md:h-14 bg-white dark:bg-slate-950 border-gray-200 dark:border-slate-800 rounded-xl md:rounded-2xl dark:text-white" />
