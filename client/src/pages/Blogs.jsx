...
const Blogs = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 dark:bg-slate-950 relative overflow-hidden pt-24 pb-20 transition-colors duration-500">
            ...
            <SEO
                title="Hair Industry Insights & Care Tips | Jony Hair Enterprise Blog"
                ...
                keywords="Raw hair care tips, human hair industry blog, hair extension maintenance guide, Jony Hair Enterprise blog, Indian hair export news"
