...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 dark:bg-slate-950 relative overflow-hidden pt-24 pb-20 transition-colors duration-500">
            ...
            <SEO
                title="Contact Us | Jony Hair Enterprise - Beldanga, Murshidabad"
                description="Visit our factory at Begun bari, Beldanga (742133). Contact Tofajul Aktar for bulk hair export inquiries via WhatsApp or Email. Worldwide shipping available."
                keywords="Jony Hair address Beldanga, contact hair exporter Murshidabad, Tofajul Aktar phone number, Begun bari Beldanga hair factory, 742133 hair supplier"
