...
const uploadToCloudinary = (fileBuffer) => {
  return new Promise((resolve, reject) => {
    const uploadStream = cloudinary.uploader.upload_stream(
      { folder: "jony-hair-users", resource_type: "auto" },
      (error, result) => {
...
router.post("/forgotpassword", async (req, res) => {
  ...
  try {
    ...
    const msg = {
      ...
      subject: "Reset Your Password - Jony Hair Enterprise",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
            <div style="text-align: center; padding-bottom: 20px;">
                <h2 style="color: #6d28d9;">Jony Hair Enterprise</h2>
            </div>
            <div style="background-color: #f9fafb; padding: 20px; border-radius: 8px;">
                ...
                <p style="color: #4b5563; font-size: 14px; line-height: 1.5;">
                    You recently requested to reset your password for your Jony Hair Enterprise account. Click the button below to proceed.
                </p>
